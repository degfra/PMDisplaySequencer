...
--
-- Client: localhost
-- Généré le: Mar 29 Octobre 2013 à 17:07
...
(5, 'Main area 1', '<h1>Main area 1</h1>\r\n<img src=''../../images/beach.jpg'' width=''400'' height=''267''/>', 3, 1),
(6, 'Main area 2', '<h1>Main area 2</h1>', 3, 2),
...
INSERT INTO `sectiontype` (`id`, `sectiontypename`, `sectiontypecode`) VALUES
(1, 'Header', '<h4>Header</h4>'),
(2, 'Left sidebar', '<h4>Left sidebar</h4>'),
(3, 'Main area', '<h4>Main content area</h4>'),
(4, 'Right sidebar', '<h4>Right sidebar</h4>'),
(5, 'Footer', '<h4>Footer</h4>');
